...
Neutrophil.regression <- lm(Body.Mass.Index..BMI...kg.m.2. ~ Neutrophil_PCT...., data = IBS)
summary(Neutrophil.regression)
...
sink('../data_output/NeutrophilsRegression.txt', append = TRUE)
print(Neutrophil.regression)
sink()


sink('../data_output/NeutrophilGX.txt')
print(storage)
sink()
